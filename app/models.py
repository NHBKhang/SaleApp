...
if __name__ == '__main__':
    with app.app_context():
        ...
        #          role=UserRole.ADMIN, email='admin@gmail.com')
        ...
        # p7 = Product(name=' iPad Gen 9', price=9980000, category_id=2,
        #              image='https://cdn.hoanghamobile.com/i/productlist/dsp/Uploads/2021/09/15/image-removebg-preview-27.png',
        #              description='Máy tính bảng iPad Gen 9 10.2" 4G (64GB) - Chính hãng Apple Việt Nam')
